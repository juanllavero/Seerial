...
public class MainWindowController extends StackPane {
	...
	public void initActions() {
		...
		//------------------------ TestMain Resizable window styling -------------------------
		...
		exit.setOnAction(a -> TestMain.primaryStage.close());

		minimize.setOnAction(a -> TestMain.primaryStage.setIconified(true));

		maximizeNormalize.setOnAction(a -> TestMain.borderlessScene.maximizeStage());

		aeroSnap.selectedProperty().bindBidirectional(TestMain.borderlessScene.snapProperty());
